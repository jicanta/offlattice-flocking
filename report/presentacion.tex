...
\begin{frame}{Modelo de votante: animación y evolución temporal}
    \begin{columns}[T,onlytextwidth]
        ...
        \begin{column}{0.23\textwidth}
            ...
            cuadro: $\eta = \SI{0.5}{rad}$, semilla 1, \SI{3e3}{s}
            \vspace{1.6em}

            \setup{Con el $\eta$ que ordenaba al estándar}
            Sin bandada única: \alert{dominios} transitorios y $\va$ oscilante
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Clusters: evolución temporal de la componente gigante}
    \figpar[0.72]{d_clusters/va_S_vs_t_vicsek_rho1pi_etas0.5-2-5_promedioM20.png}{%
        ...
        \setup{$S$ con transitorio propio}
        $0{,}15 \to$ crece por \alert{agregación} \\[0.4em]
        $\teq = \SI{3.65e3}{s}$}
\end{frame}
...
\begin{frame}{Polarización contra componente gigante}
    \dosfiglimpio
        ...
        {\paneles{modelo estándar}{modelo de votante}
         ...
         \setup{Dos regímenes}
         $\rho = 8$ y $2$: \alert{desacopladas} \\[0.4em]
