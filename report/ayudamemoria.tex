...
\begin{notas}
    \item \decir La tabla separa los parámetros \textbf{del sistema} (la caja,
          el radio de interacción, la rapidez, el ruido, la densidad y la
          regla) de los \textbf{de la simulación}: el paso temporal y las
          realizaciones.
