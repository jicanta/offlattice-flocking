...
\begin{notas}
    ...
    \item \decir Adelantar de palabra cómo pasamos de la curva al escalar (no
          hay diapositiva para esto). El valor escalar se mide sólo en el
          estacionario, con un criterio automático, sin umbrales a mano:
          tomamos la curva \emph{promedio} de las \num{20} realizaciones,
          calculamos su media en la segunda mitad de la corrida, y \teq{} es el
          inicio del primer bloque de \SI{50}{s} cuya media cruza esa
          referencia. Es único por caso, no depende de la semilla, y es el
          mismo para \va{} y para $S$.
    \item \decir El escalar es el promedio de \emph{todas} las muestras con
          $t \ge \teq$ de las \num{20} realizaciones, y la barra de error de
          todas las curvas es el desvío estándar de esas mismas muestras.
